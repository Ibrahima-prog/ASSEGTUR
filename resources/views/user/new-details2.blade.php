...
<head>
    ...
    <title>JOURNAL &#8211 {{$newsitem->frtitle}}</title>
            ...
            <div class="row_col_wrap_12 col span_12 custom left">
                ...
                <div class="vc_column-inner">
                    ...
                    <div class="wpb_wrapper">
                        ...
                        <div class="wpb_wrapper">
                            <p><span
                                style="font-family: gta-bold; font-size: 15px; letter-spacing: 2px;">{{$newsitem->author}}<br>
                                {{$newsitem->created_at}}</span></p>
                            </div>
                        </div>
...
<div class="inner-wrap">
    <div class="inner" data-prepend-menu-mobile="false">
        <a class="slide_out_area_close" href="#">
            <span class="close-wrap" style="top:50px">
