                 ...
                 @foreach($news as $newsitem)
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                      <h2><a href="{{ route('newsDetails', $newsitem->slug) }}">
                        @if(App::getLocale() == 'tr') {{ $newsitem->trtitle }} @elseif (App::getLocale() == 'en') {{ $newsitem->entitle }}
                   ...
                   @if(App::getLocale() == 'tr') 
                    {!! \Illuminate\Support\Str::words($newsitem->trbody, 60 ,'  ...')  !!}
                   @elseif (App::getLocale() == 'en') 
                        {!! \Illuminate\Support\Str::words($newsitem->enbody, 60 ,'  ...')  !!}
                        @else
                        {!! \Illuminate\Support\Str::words($newsitem->frbody, 60 ,'  ...')  !!}
                      ...
                      @foreach($newsTitles as $newsitem)
                        ...
                        <div class="row margin-bottom-10">
                          <div class="col-md-9 col-md-offset-1 recent-news-inner">
                            <h3><a href="{{ route('newsDetails', $newsitem->slug) }}">
                              @if(App::getLocale() == 'tr') {{ $newsitem->trtitle }} @elseif (App::getLocale() == 'en')
