      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Aktat Hakkımızda Metin</h3>
          </div>
        ...
        <form action="{{ route('admin.topluluk.aktathakkinda.save') }}" method="post">
          ...
          {{ csrf_field() }}
            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="title"><img src="../../../../admin/images/countries/tr.png" alt="Turksih"> TR - Metin Başlığı</label>
             ...
             <div class="box-header">
               ...
               <!-- /.box-header -->
                <div class="box-body pad">
                 ...
                 <textarea name="enabout" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor1" required> @if ($post) {{ $post->enabout }} @endif</textarea>
               </div>
                <div class="box-body pad">
                  <label for="title"><img src="../../../../admin/images/countries/tr.png" alt="Turkish"> TR - Duyuru Metni</label>
                 <textarea name="trabout" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor2" required> @if ($post) {{ $post->trabout }} @endif</textarea>
               </div>
