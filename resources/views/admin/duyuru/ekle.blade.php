  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <form role="form" action="{{ route('admin.duyuru.ekle.save') }}" method="post" enctype="multipart/form-data">
          ...
          {{ csrf_field() }}
            ...
            <div class="box-body">        
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="title" name="entitle" placeholder="Duyuru Başlığı" required>
                    </div>  
                </div>
                ...
                <div class="col-md-6">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="title" name="trtitle" placeholder="Duyuru Başlığı" required>
                    </div>  
                </div>
            ...
            <div class="box-body">
            <div class="form-group">
                  <label for="image">Imaji Şeç - (800,600)</label>  
