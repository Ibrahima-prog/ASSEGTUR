...
<!-- Head BEGIN -->
    ...
    {{-- <head>
      ...
      <meta name="description" content= "ASSEGTUR"/>
      ...
      <section id="services">
        <div class="container">
          ...
          <header class="section-header wow fadeInUp">
            <h3> <br><br>
               Erreur 404 | La page que vous cherchez n'a pas été trouvée 
              </h3>
            <p>
            <a href="/">Cliquez ici pour retourner à la page d'acceuil.</a> 
